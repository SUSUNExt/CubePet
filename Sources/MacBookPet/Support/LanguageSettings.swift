...
enum PetCustomizationText {
    ...
    case smallBlackBlockEyesBlack
    case cookieBlackBeanEyes
    case officialEyes
    case myEyePresets
    case importEyes
...
final class LanguageSettings: ObservableObject {
    ...
    func customizationText(_ key: PetCustomizationText) -> String {
        ...
        case (.english, .smallBlackBlockEyesBlack): "Small Black Block Eyes (Black)"
        case (.english, .cookieBlackBeanEyes): "Little Black Bean Eyes"
        ...
        case (.english, .eyeDetailSettings): "Eye Details"
        case (.english, .eyeSize): "Eye Size"
        case (.english, .eyeMovement): "Eye Movement"
        ...
        case (.japanese, .smallBlackBlockEyesBlack): "小さな黒い四角の目（黒）"
        case (.japanese, .cookieBlackBeanEyes): "小さな黒豆アイ"
        ...
        case (.japanese, .brown): "茶色"
        case (.japanese, .size): "サイズを調整"
        case (.japanese, .decreaseSize): "表示サイズを小さくする"
        case (.japanese, .increaseSize): "表示サイズを大きくする"
        case (.japanese, .eyeDetailSettings): "目の詳細設定"
        case (.japanese, .eyeSize): "目のサイズ"
        case (.japanese, .eyeMovement): "目の移動量"
        ...
        case (.korean, .smallBlackBlockEyesBlack): "작은 검은 네모 눈 (검정)"
        case (.korean, .cookieBlackBeanEyes): "작은 검은콩 눈"
        ...
        case (.korean, .brown): "갈색"
        case (.korean, .size): "크기 조절"
        case (.korean, .decreaseSize): "표시 크기 줄이기"
        case (.korean, .increaseSize): "표시 크기 늘리기"
        case (.korean, .eyeDetailSettings): "눈 상세 설정"
        case (.korean, .eyeSize): "눈 크기"
        case (.korean, .eyeMovement): "눈 이동량"
        ...
        case (.simplifiedChinese, .smallBlackBlockEyesBlack): "小黑块眼睛(黑)"
        case (.simplifiedChinese, .cookieBlackBeanEyes): "小黑豆眼睛"
        ...
        case (.simplifiedChinese, .brown): "棕色"
        case (.simplifiedChinese, .size): "调整大小"
        case (.simplifiedChinese, .decreaseSize): "缩小展示大小"
        case (.simplifiedChinese, .increaseSize): "放大展示大小"
        case (.simplifiedChinese, .eyeDetailSettings): "眼睛详细设置"
        case (.simplifiedChinese, .eyeSize): "眼睛大小"
        case (.simplifiedChinese, .eyeMovement): "眼睛移动幅度"
        ...
        case (.traditionalChinese, .smallBlackBlockEyesBlack): "小黑塊眼睛(黑)"
        case (.traditionalChinese, .cookieBlackBeanEyes): "小黑豆眼睛"
        ...
        case (.traditionalChinese, .brown): "棕色"
        case (.traditionalChinese, .size): "調整大小"
        case (.traditionalChinese, .decreaseSize): "縮小顯示大小"
        case (.traditionalChinese, .increaseSize): "放大顯示大小"
        case (.traditionalChinese, .eyeDetailSettings): "眼睛詳細設定"
        case (.traditionalChinese, .eyeSize): "眼睛大小"
        case (.traditionalChinese, .eyeMovement): "眼睛移動幅度"
    ...
    func foodName(_ name: FoodName) -> String {
        ...
        case (.english, .fishShapedPastry): "Fish-Shaped Pastry"
        case (.english, .puddingCup): "Pudding Cup"
        case (.english, .threeColorDango): "Three-Color Dango"
        case (.japanese, .smallCookie): "ミニクッキー"
        case (.japanese, .energyBar): "エナジーバー"
        case (.japanese, .petCola): "ペットコーラ"
        case (.japanese, .fishShapedPastry): "たい焼き"
        case (.japanese, .puddingCup): "プリンカップ"
        case (.japanese, .threeColorDango): "三色団子"
        case (.korean, .smallCookie): "작은 쿠키"
        case (.korean, .energyBar): "에너지 바"
        case (.korean, .petCola): "펫 콜라"
        case (.korean, .fishShapedPastry): "붕어빵"
        case (.korean, .puddingCup): "푸딩 컵"
        case (.korean, .threeColorDango): "삼색 당고"
        case (.simplifiedChinese, .smallCookie): "小饼干"
        case (.simplifiedChinese, .energyBar): "能量棒"
        case (.simplifiedChinese, .petCola): "宠物可乐"
        case (.simplifiedChinese, .fishShapedPastry): "鱼形烧饼"
        case (.simplifiedChinese, .puddingCup): "布丁杯"
        case (.simplifiedChinese, .threeColorDango): "三色团子"
        case (.traditionalChinese, .smallCookie): "小餅乾"
        case (.traditionalChinese, .energyBar): "能量棒"
        case (.traditionalChinese, .petCola): "寵物可樂"
        case (.traditionalChinese, .fishShapedPastry): "魚形燒餅"
        case (.traditionalChinese, .puddingCup): "布丁杯"
        case (.traditionalChinese, .threeColorDango): "三色糰子"
        }
    }

    func skinName(_ name: PetSkinName) -> String {
        skinName(name, language: language)
    }

    func skinName(_ name: PetSkinName, language: AppLanguage) -> String {
        switch (language, name) {
        ...
        case (.english, .ice): "Ice Cube"
        case (.english, .rainbow): "Rainbow Cube"
        case (.english, .ice2): "Ice Cube 2"
        case (.english, .rainbow2): "Rainbow Cube 2"
        ...
        case (.english, .cookieClassic): "Little Cookie"
        ...
        case (.japanese, .ice): "アイスキューブ"
        case (.japanese, .rainbow): "レインボーブロック"
        case (.japanese, .ice2): "アイスキューブ 2"
        case (.japanese, .rainbow2): "レインボーブロック 2"
        ...
        case (.japanese, .cookieClassic): "ちいさなクッキー"
        case (.korean, .classic): "검은 블록"
        case (.korean, .blue): "파란 블록"
        case (.korean, .green): "초록 블록"
        case (.korean, .red): "빨간 블록"
        case (.korean, .pink): "분홍 블록"
        case (.korean, .ice): "얼음 블록"
        case (.korean, .rainbow): "무지개 블록"
        case (.korean, .ice2): "얼음 블록 2"
        case (.korean, .rainbow2): "무지개 블록 2"
        ...
        case (.korean, .cookieClassic): "작은 쿠키"
        ...
        case (.simplifiedChinese, .ice): "水晶方块"
        case (.simplifiedChinese, .rainbow): "彩虹方块"
        case (.simplifiedChinese, .ice2): "冰块"
        case (.simplifiedChinese, .rainbow2): "彩虹糖方块"
        ...
        case (.simplifiedChinese, .cookieClassic): "小曲奇"
        ...
        case (.traditionalChinese, .ice): "水晶方塊"
        case (.traditionalChinese, .rainbow): "彩虹方塊"
        case (.traditionalChinese, .ice2): "冰塊"
        case (.traditionalChinese, .rainbow2): "彩虹糖方塊"
        ...
        case (.traditionalChinese, .cookieClassic): "小曲奇"
        }
    }
    ...
    func petName(_ name: PetName) -> String {
        ...
        case (.traditionalChinese, .cookie): "小曲奇"
        }
    }
